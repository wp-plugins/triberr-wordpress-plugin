        ...
        <ul>
            	<li>
                   ...
                   <select name="triberr_comments_status" id="triberr_comments_status">
                   	<option value="yes" <?php if($triberr_comments_status == "yes"){ echo "selected=\"selected\""; } ?>>Yes</option>
                    <option value="no" <?php if($triberr_comments_status == "no"){ echo "selected=\"selected\""; } ?>>No</option>
                   </select>
                 </li>  
                   <br />
                <li>
